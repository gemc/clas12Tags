...
{
	print "\n Usage: \n";
	print "   urwt.pl <configuration filename>\n";
...
my @allConfs = ("default", "urwt1", "urwt2", "urwt_proto");
...
# run urwt factory from COATJAVA to produce volumes
...
# print "Using NLAYERS = $NLAYERS in Perl script\n";
	coatjava::init_urwt_from_ccdb($variation);
