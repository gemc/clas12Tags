...
{
	print "\n Usage: \n";
	print "   recoil_tof.pl <configuration filename>\n";
...
#	$configuration{"variation"} = $conf ;
    ...
    system("/w/hallb-scshelf2102/clas12/users/nwickjlb/coatjava_edit/coatjava/coatjava/bin/run-groovy factory.groovy --variation $configuration{variation}  --runnumber 11");
