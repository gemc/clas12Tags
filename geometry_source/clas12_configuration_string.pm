...
# comments on the table above: The RGM targets need all the runs because of target switches
# the micromegas only need one rgd_fall2023 variation, one rgl_spring2025 and one rge_spring2024
