...
my @allConfs = ("default_1R", "default_2R", "proto", "ddvcs");
my @allNregions =("1","2","1","6");
...
#	$configuration{"variation"} = $conf ;
  ...
  #  %configuration = $configuration{"variation"};
    ...
    print "variation \n";
    print "$configuration{variation}\n";
    coatjava::makeURWELL($configuration{"number_of_Region"},$configuration{"variation"});

#    if ($configuration{"variation"} eq "proto"){
#        print "variation proto\n";
#        coatjava::makeURWELL_PROTO($configuration{"number_of_Region"},$configuration{"variation"} );
#    }
