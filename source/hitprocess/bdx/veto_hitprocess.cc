...
map<string, double> veto_HitProcess :: integrateDgt(MHit* aHit, [[maybe_unused]] int hitn)
{
...
vector<identifier>  veto_HitProcess :: processID(vector<identifier> id, [[maybe_unused]] G4Step *step, [[maybe_unused]] detector Detector)
{
