...
static ltccConstants initializeLTCCConstants(int runno, string digiVariation = "default", string digiSnapshotTime = "no", [[maybe_unused]] bool accountForHardwareStatus = false)
{
...
vector<identifier>  ltcc_HitProcess :: processID(vector<identifier> id, [[maybe_unused]] G4Step *step, [[maybe_unused]] detector Detector)
{
