#ifndef urwt_HITPROCESS_H
#define urwt_HITPROCESS_H 1
...
class urwt_HitProcess : public HitProcess
{
public:
	~urwt_HitProcess() { ; }
	...
	static HitProcess *createHitClass() { return new urwt_HitProcess; }
