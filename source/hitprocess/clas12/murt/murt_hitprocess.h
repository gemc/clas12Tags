#ifndef murt_HITPROCESS_H
#define murt_HITPROCESS_H 1

/// \file murt_hitprocess.h
/// murt_hitprocess.h defines the barrel micromegas hit process routine class.\n
...
class murt_HitProcess : public HitProcess
{
public:
	...
	static HitProcess *createHitClass() {return new murt_HitProcess;}
