...
vector<double> fmt_strip::FindStrip(int layer, [[maybe_unused]] int sector, double x, double y, double z, double Edep, const fmtConstants& fmtc)
{
...
double fmt_strip::Weight_td(int strip, double x, double y, [[maybe_unused]] double z, const fmtConstants& fmtc){
