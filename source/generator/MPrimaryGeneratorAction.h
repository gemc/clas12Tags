...
public:
	...
	~MPrimaryGeneratorAction() override;
...
public:
	...
	double getTimeWindow() const { return TWINDOW; }
	double getStartTime() const { return TSIGNAL; }
...
private:
	...
	double        cminp,   cmaxp;            ///< minimum and maximum cosmic ray momentum
