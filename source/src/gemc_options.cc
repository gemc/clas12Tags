...
void goptions::setGoptions()
{
	...
	optMap["RFSETUP"].help += "      3. offset (in ns)\n";
	optMap["RFSETUP"].help += "     To add additional signals, provide 2 per signal: an RF signal with that time distance from the original.\n";
	optMap["RFSETUP"].help += "      1. radioInterval (in number of bunches): distance between original signal.\n";
	optMap["RFSETUP"].help += "      2. offset (in ns)\n";
	optMap["RFSETUP"].help += "     Example1:  4.008 (0.2495 GHz) RF signal, 1 output, output frequency is 50 bunches, no offset: \n";
	optMap["RFSETUP"].help += "      -RFSETUP=\"4.008, 50, 0\" \n";
	optMap["RFSETUP"].help += "     Example2: two (0.5 GHz) and 2 RF signals, separated by 30 ns and both output frequency is 80 bunches, both 3 and 4 ns offset: \n";
	optMap["RFSETUP"].help += "      -RFSETUP=\"2.004, 80, 3, 30, 4\" \n";
